 ...
 * {@code DeciveStatus}, sobre el contexto de persistencia definido para el
 * aplicativo.
 * <p>
 ...
 * repositorio de datos para la entidad {@code DeviceStatus}. En otras palabras,
...
public interface IDeviceStatusDAO {
	 ...
	 * de instancias {@code DeviceStatus} almacenadas en el contexto de
	 * persistencia definido y aplicando una serie de filtros para refinar la
	 * b&uacute;squeda en concreto.
	 * <p>
	 * Esta funci&oacute;n obtendr&aacute; un listado de todas las reservas
	 * correspondientes a un determinado dispostivo, y cuyas fechas y horas
	 * almacenadas se presentan como un conflicto para insertar alg&uacute;n
	 * nuevo registro que represente una nueva reserva ante el sistema.
	 * <p>
	 ...
	 * definidos para una determinada entidad {@code DeviceStatus}, es decir, se
	 ...
	 * 
	 * @param deviceId
	 *            Instancia que representa el identificador &uacute;nico del
	 *            dispositivo que se desea reservar.
	 * @param startDate
	 *            Instancia que representa la fecha de inicio estimada para el
	 *            nuevo pr&eacute;stamo.
	 * @param endDate
	 *            Instancia que representa la fecha de finalizaci&oacute;n
	 *            estimada para el nuevo pr&eacute;stamo.
	 * @param startTime
	 *            Instancia que representa la hora de inicio estimada para el
	 *            nuevo pr&eacute;stamo.
	 * @param endTime
	 *            Instancia que representa la hora de finalizaci&oacute;n
	 *            estimada para el nuevo pr&eacute;stamo.
	 * @return Un objeto tipo lista que contiene todos los registros almacenados
	 *         y que se presenten como conflictos para la nueva reserva.
	 ...
	 * b&uacute;squeda en concreto.
	 * <p>
	 * Esta funci&oacute;n utilizar&aacute; los par&aacute;metros enviados para
	 * efectuar los filtros, los cuales estar&aacute;n definidos por las reglas
	 * del negocio sobre la b&uacute;squeda de los pr&eacute;stamos de los
	 * dispositivos a ser evaluados.
	 * <p>
	 * Los filtros aplicados a la b&uacute;squeda se efectuar&aacute;n aplicando
	 * la conjunci&oacute;n <b>AND</b>, en otras palabras, las instancias
	 * obtenidas desde el contexto de persistencia y retornadas exitosamente,
	 ...
	 *            negocio.
	 * @param currentDate
	 *            Instancia que representa la fecha y hora m&iacute;nima a
	 *            partir de la cual se consultar&aacute;n los registros.
	 ...
	 * una entidad del tipo {@code DeviceStatus} que se desea persistir
	 * f&iacute;sicamente.
	 * <p>
	 ...
	 * pertenecientes a una entidad del tipo {@code DeviceStatus}, la cual ya
	 * estaba persistida previamente.
	 * <p>
	 * Este m&eacute;todo realizar&aacute; un mapeo adecuado entre los atributos
