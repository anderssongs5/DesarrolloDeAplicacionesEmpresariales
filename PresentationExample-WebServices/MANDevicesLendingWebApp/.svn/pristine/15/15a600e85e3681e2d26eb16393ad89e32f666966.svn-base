 ...
 * repositorio de datos para la entidad {@code Profile}. En otras palabras, el
...
public interface IProfileDAO {
	 ...
	 * sido salvada previamente y que es del tipo de entidad {@code Profile}.
	 * <p>
	 ...
	 * salvadas previamente que son del tipo de entidad {@code Profile}.
	 * <p>
	 ...
	 * asociados al tipo de objeto o entidad {@code Profile}.
	 * <p>
	 ...
	 * una entidad del tipo {@code Profile} que se desea persistir
	 * f&iacute;sicamente.
	 * <p>
