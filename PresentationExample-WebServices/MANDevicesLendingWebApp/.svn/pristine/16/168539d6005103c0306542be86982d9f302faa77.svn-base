 ...
 * repositorio de datos para la entidad {@code Client}. En otras palabras, el
...
public interface IClientDAO {
	 ...
	 * sido salvada previamente y que es del tipo de entidad {@code Client}.
	 * <p>
	 ...
	 * de instancias {@code Client} almacenadas en el contexto de persistencia
	 ...
	 * definidos para una determinada entidad {@code Client}, es decir, se
	 ...
	 * una entidad del tipo {@code Client} que se desea persistir
	 * f&iacute;sicamente.
	 * <p>
	 ...
	 * pertenecientes a una entidad del tipo {@code Client}, la cual ya estaba
