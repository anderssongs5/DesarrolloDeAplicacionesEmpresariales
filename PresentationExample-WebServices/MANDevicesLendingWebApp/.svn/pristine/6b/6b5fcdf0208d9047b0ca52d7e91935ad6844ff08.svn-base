 ...
 * {@code Disposition}, sobre el contexto de persistencia definido para el
 * aplicativo.
 * <p>
 ...
 * repositorio de datos para la entidad {@code Disposition}. En otras palabras,
...
public interface IDispositionDAO {
	 ...
	 * sido salvada previamente y que es del tipo de entidad {@code Disposition}
	 * .
	 * <p>
	 ...
	 * salvadas previamente que son del tipo de entidad {@code Disposition}.
	 * <p>
	 ...
	 * asociados al tipo de objeto o entidad {@code Disposition}.
	 * <p>
	 ...
	 * una entidad del tipo {@code Disposition} que se desea persistir
	 * f&iacute;sicamente.
	 * <p>
