package co.edu.udea.we.mandl.persistence.dao.exception;
 ...
 */
public class MANDevicesLendingDAOException extends Exception {
	 ...
	 * aplicaci&oacute;n.
	 */
	public MANDevicesLendingDAOException() {
		super();
	 ...
	 */
	public MANDevicesLendingDAOException(String message) {
		super(message);
		LOG.error("MANDevicesLendingDAOException: An error has happened during process."
				+ message);
	}
	 ...
	 *            ser lanzado.
	 */
	public MANDevicesLendingDAOException(Throwable cause) {
		super(cause);
		LOG.error(
	 ...
	 *            ser lanzado.
	 */
	public MANDevicesLendingDAOException(String message, Throwable cause) {
		super(message, cause);
		LOG.error(
				"MANDevicesLendingDAOException: An error has happened during process.",
				cause);
