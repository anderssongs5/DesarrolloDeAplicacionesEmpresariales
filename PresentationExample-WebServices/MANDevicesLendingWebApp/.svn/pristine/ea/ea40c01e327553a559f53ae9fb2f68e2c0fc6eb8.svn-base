 ...
 * {@code IPersonDAO}; por otra parte, esta clase hereda indirectamente de clase
 ...
 * las entidades pertencientes a la clase {@code Person}, son solo aquellos que
 * se han definido en la interfaz o prototipo {@code IPersonDAO}; de ese modo,
 * esta clase se convierte en un D.A.O. <i>Data Access Object</i>, para
 * gestionar los datos de las entidades {@code Person}.
 * 
 * @since JDK1.7
 * 
 * @version 1.0
 ...
 */
public class PersonDAOImpl extends AbstractEntityDAO implements IPersonDAO {
	...
	@Override()
	public Person find(PersonId personId) throws MANDevicesLendingDAOException {

		return ((Person) super.find(Person.class, personId));
	}

	@Override()
	public Person save(Person person) throws MANDevicesLendingDAOException {
		PersonId personKey = (PersonId) super.save(person);

		return ((personKey != null) ? person : null);
	}
}