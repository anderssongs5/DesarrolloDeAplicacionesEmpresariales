package co.edu.udea.appempresariales.socialplus.config.cors;
...
public class SocialPlusContainerResponseFilter implements
		ContainerResponseFilter {

	public SocialPlusContainerResponseFilter() {
		super();
	}
